...
#
# [*is_minimal*]
# Bolean for minimal DevStack installation with default configuration
#
# [*zanata_cli*]
...
#
# [*is_shutdown*]
# Bolean for shutdown and delete DevStack
#
# [*restack*]
...
class translation_checksite (
  ...
  if $is_minimal {
    $local_conf = 'translation_checksite/local.conf.minimal.erb'
  } else {
    $local_conf = 'translation_checksite/local.conf.erb'
  }
